...
public class FreeBoardDao {
    ...
    public void post(BoardDto boardDto) {
        ...
        this.jdbcTemplate.update(POST, boardDto.getTitle(), boardDto.getContent(), boardDto.getWRITER_ID());
    ...
    public void modify(BoardDto boardDto) {
        ...
        this.jdbcTemplate.update(MODIFY, boardDto.getTitle(), boardDto.getContent(), boardDto.getModdate().toString(), boardDto.getId());
    ...
    public List<BoardDto> getBoardList() {
        ...
        boardDtoList = this.jdbcTemplate.query(GET_BOARD_LIST, new BoardRowMapper());
    ...
    public BoardDto getBoard(int id) {
        ...
        boardDto = this.jdbcTemplate.queryForObject(GET_BOARD, args, new BoardRowMapper());
