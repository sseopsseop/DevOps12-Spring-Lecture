...
public class NoticeDaoJdbcDaoSupport extends JdbcDaoSupport {
    ...
    public void post(BoardDto boardDto) {
        ...
        getJdbcTemplate().update(POST, boardDto.getTitle(), boardDto.getContent(),
    ...
    public List<BoardDto> getNoticeList() {
        ...
        List<BoardDto> noticeList = getJdbcTemplate().query(GET_NOTICE_LIST,
                new BoardRowMapper());
    ...
    public BoardDto getNotice(int id) {
        ...
        Object[] args = {id};
        BoardDto boardDto = getJdbcTemplate().queryForObject(GET_NOTICE, args, new BoardRowMapper());
